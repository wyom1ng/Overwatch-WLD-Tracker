...
namespace NeuralNetwork.Patterns
{
    public class Pattern : NeuroObject
    {
        ...
        public override void Load(double[] loadData)
        {
            ...
            for (var i = 0; i < InputsCount; i++)
            {
                ...
                {
                    //Input[i] = binaryReader.ReadDouble();
                }
            }
            for (var i = 0; i < OutputsCount; i++)
            {
                ...
                {
                    //Output[i] = binaryReader.ReadDouble();
                }
            }
        }
    }
    ...
    public abstract class NeuroObjectCollection : CollectionBase
    {
        ...
        {
            int itemsCount;
            if (!NeuroObject.loadFromFile)
            {
                itemsCount = Convert.ToInt32(NeuroObject.ExtractDataFromArray(loadData));
            }
            else
            {
                itemsCount = binaryReader.ReadInt32();
            }
